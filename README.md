...
- `mis/kernel/AetherRouteKernel.mis`
...
```bash
bin/misc mis/kernel/AetherRouteKernel.mis --check --compact-letters
find mis -name '*.mis' -print0 | xargs -0 -n1 bin/misc --check --compact-letters
```

## Org

[clarity-fintech/aether-route](https://github.com/clarity-fintech/aether-route)
